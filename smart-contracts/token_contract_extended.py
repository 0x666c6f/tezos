...
class FA12_core(sp.Contract):
    ...
    def transfer(self, params):
        ...
        sp.
        if (params.from_ != sp.sender) & (~self.is_administrator(sp.sender)):
...
class FA12(FA12_mint_burn, FA12_administrator, FA12_pause, FA12_core):
    def __init__(self, admin, cap):
        FA12_core.__init__(self, paused=False, administrator=admin, cap=cap)
